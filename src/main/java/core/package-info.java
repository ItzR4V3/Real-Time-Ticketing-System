 ...
 * <ul>
 *   <li>{@link core.Main} - The main class that starts the event ticketing simulation. It initializes configuration, creates and starts vendor and customer threads, and handles stopping threads based on user input.</li>
